...
export default function useBlockControlProps(controlProps, { className, ...data } = {}) {
  ...
  const props = {
    label: controlTypeData.restrictions.label_settings ? controlProps.data.label : false,
    help: controlTypeData.restrictions.help_settings ? controlProps.data.help : false,
