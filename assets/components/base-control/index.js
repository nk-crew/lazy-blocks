...
export default function BaseControl(props) {
  ...
  return (
    <div {...allProps} className={classnames('lazyblocks-component-base-control', className)}>
      {label ? <div className="lazyblocks-component-base-control__label">{label}</div> : null}
      {children}
