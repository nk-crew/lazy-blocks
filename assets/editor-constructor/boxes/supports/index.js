		...
		<>
			...
			{!window.GHOSTKIT ? (
				<BaseControl>
					...
					>
						<p>
							{__(
								'Install Ghost Kit plugin to use the following settings.',
								'lazy-blocks'
							)}
						</p>
						<Button
			...
			!supportsClassname ? (
				<BaseControl>
					...
					>
						<p>
							{__(
								'To use these extensions required "Class Name" support.',
								'lazy-blocks'
							)}
						</p>
					</Notice>
			...
			<GktWrap>
				<ToggleControl
					...
					onChange={(value) =>
						updateData({ supports_ghostkit_spacings: value })
					}
				/>
				<ToggleControl
					...
					onChange={(value) =>
						updateData({ supports_ghostkit_display: value })
					}
				/>
				<ToggleControl
				...
				<ToggleControl
					...
					onChange={(value) =>
						updateData({ supports_ghostkit_frame: value })
					}
				/>
				<ToggleControl
					...
					onChange={(value) =>
						updateData({ supports_ghostkit_custom_css: value })
					}
				/>
			</GktWrap>
		</>
