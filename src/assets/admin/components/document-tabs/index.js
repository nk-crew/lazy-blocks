                    ...
                    <ul>
                        <li>
                            ...
                            <button
                                ...
                                className={ `components-button edit-post-sidebar__panel-tab ${ 'block' === activeTab ? 'is-active' : '' }` }
                        ...
                        <li>
                            ...
                            <button
                                ...
                                className={ `components-button edit-post-sidebar__panel-tab ${ 'control' === activeTab ? 'is-active' : '' }` }
