            ...
            >
                ...
                <div className="lzb-constructor-controls-item-label">
                    ...
                    <span className="lzb-constructor-controls-item-label-buttons">
                        { ! isUseOnce ? (
                            ...
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 4.75H18C18.6904 4.75 19.25 5.30964 19.25 6V13C19.25 13.6904 18.6904 14.25 18 14.25H11C10.3096 14.25 9.75 13.6904 9.75 13V6C9.75 5.30964 10.3096 4.75 11 4.75Z" stroke="currentColor" strokeWidth="1.5" />
                                    <path fillRule="evenodd" clipRule="evenodd" d="M7 10.5H6C5.72386 10.5 5.5 10.7239 5.5 11V18C5.5 18.2761 5.72386 18.5 6 18.5H13C13.2761 18.5 13.5 18.2761 13.5 18V17H15V18C15 19.1046 14.1046 20 13 20H6C4.89543 20 4 19.1046 4 18V11C4 9.89543 4.89543 9 6 9H7V10.5Z" fill="currentColor" />
                                </svg>
                        ...
                        >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.33734 7.1706C6.23299 6.4793 6.76826 5.85717 7.4674 5.85717H16.5326C17.2317 5.85717 17.767 6.4793 17.6627 7.17061L15.9807 18.3134C15.8963 18.8724 15.416 19.2857 14.8507 19.2857H9.14934C8.58403 19.2857 8.10365 18.8724 8.01928 18.3134L6.33734 7.1706Z" stroke="currentColor" strokeWidth="1.71429" />
                                <rect x="4" y="5" width="16" height="2" fill="currentColor" />
                                <path d="M14.2857 5C14.2857 5 13.2624 5 12 5C10.7376 5 9.71428 5 9.71428 5C9.71428 3.73763 10.7376 2.71429 12 2.71429C13.2624 2.71429 14.2857 3.73763 14.2857 5Z" fill="currentColor" />
                            </svg>
