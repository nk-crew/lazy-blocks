...
class CustomCodeSettings extends Component {
  ...
  render() {
    const { data, updateData, currentTheme, onTabChange } = this.props;
    ...
    return (
      <div className="lzb-constructor-custom-code-settings">
        ...
        <PanelBody>
          <BaseControl label={__('Output Method', '@@text_domain')}>
            <RadioControl
              options={[
                {
              ...
              <BaseControl>
                {tabs.length > 1 ? (
                  <TabPanel
                    ...
                    tabs={tabs}
                    onSelect={(value) =>
                      this.setState({ tab: value }, () => onTabChange && onTabChange(value))
                    }
                  >
                    {() => null}
                  </TabPanel>
                ...
                {!showInfo ? (
                  ...
                  <Notice status="info" isDismissible={false} className="lzb-constructor-notice">
                    <p className="description">
                      ...
                      <a
                        href="https://lazyblocks.com/documentation/blocks-controls/text/?utm_source=plugin&utm_medium=constructor&utm_campaign=how_to_use_control&utm_content=@@plugin_version"
                        target="_blank"
                    ...
                    <p className="description">
                      ...
                      <a
                        href="https://lazyblocks.com/documentation/blocks-code/php-callback/?utm_source=plugin&utm_medium=constructor&utm_campaign=how_to_use_php_callback&utm_content=@@plugin_version"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
          ...
          <PanelBody>
            ...
            >
              ...
              <p className="description">
                ...
                <a
                  href="https://lazyblocks.com/documentation/blocks-code/theme-template/?utm_source=plugin&utm_medium=constructor&utm_campaign=how_to_use_theme_template&utm_content=@@plugin_version"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <PanelBody>
          <BaseControl label={__('Show block preview in editor', '@@text_domain')}>
            <SelectControl
              options={[
                {
